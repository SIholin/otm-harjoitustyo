...
public class User {
    ...
    /**
     * Muokkaa käyttäjän yrittämien sanojen yhteislukumäärää korvaten sen parametrilla saadulla arvolla.
     * 
     */
    ...
    /**
     * Tarkistaa onko kahdella käyttäjällä sama käyttäjätunnus ja palattaa sen boolean arvon.
     * 
     * 
     * 
     */
